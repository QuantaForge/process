...
use QuantaForge\Contracts\Process\InvokedProcess as InvokedProcessContract;
...
class FakeInvokedProcess implements InvokedProcessContract
{
     ...
     *
     * @var \QuantaForge\Process\FakeProcessDescription
     */
    protected $process;
     ...
     * @param  \QuantaForge\Process\FakeProcessDescription  $process
     * @return void
     */
