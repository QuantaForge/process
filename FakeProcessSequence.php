...
use QuantaForge\Contracts\Process\ProcessResult as ProcessResultContract;
...
class FakeProcessSequence
{
     ...
     *
     * @var \QuantaForge\Contracts\Process\ProcessResult|\QuantaForge\Process\FakeProcessDescription
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Process\ProcessResult|\QuantaForge\Process\FakeProcessDescription|array|string  $process
     * @return $this
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Process\ProcessResult|\QuantaForge\Process\FakeProcessDescription|array|string  $process
     * @return \QuantaForge\Contracts\Process\ProcessResult|\QuantaForge\Process\FakeProcessDescription
     */
